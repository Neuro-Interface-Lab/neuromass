...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "src/neuromass/models/kuramoto/_native/kuramoto_cpp_kernel.hpp"
        ],
        "include_dirs": [
            "src/neuromass/models/kuramoto/_native",
        ...
        "sources": [
            "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx",
            "src/neuromass/models/kuramoto/_native/kuramoto_cpp_kernel.cpp"
        ]
    },
    "module_name": "neuromass.models.kuramoto._native.cpp_backend"
}
END: Cython Metadata */
...
#define __PYX_HAVE__neuromass__models__kuramoto___native__cpp_backend
#define __PYX_HAVE_API__neuromass__models__kuramoto___native__cpp_backend
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "neuromass.models.kuramoto._native.cpp_backend" */
...
#define __Pyx_MODULE_NAME "neuromass.models.kuramoto._native.cpp_backend"
extern int __pyx_module_is_main_neuromass__models__kuramoto___native__cpp_backend;
int __pyx_module_is_main_neuromass__models__kuramoto___native__cpp_backend = 0;

/* Implementation of "neuromass.models.kuramoto._native.cpp_backend" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Cython_wrapper_around_the_C_impl[] = "Cython wrapper around the C++ implementation of the naive Kuramoto solver.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9neuromass_6models_8kuramoto_7_native_11cpp_backend_simulate_naive_kuramoto(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_adjacency, PyArrayObject *__pyx_v_omega, PyArrayObject *__pyx_v_theta0, double __pyx_v_epsilon, double __pyx_v_dt, int __pyx_v_n_steps); /* proto */
...
#define __pyx_n_u_n_nodes __pyx_string_tab[19]
#define __pyx_n_u_n_steps __pyx_string_tab[20]
#define __pyx_n_u_name __pyx_string_tab[21]
#define __pyx_n_u_neuromass_models_kuramoto__nativ __pyx_string_tab[22]
#define __pyx_n_u_np __pyx_string_tab[23]
#define __pyx_n_u_numpy __pyx_string_tab[24]
#define __pyx_n_u_omega __pyx_string_tab[25]
...
#define __pyx_n_u_simulate_naive_kuramoto __pyx_string_tab[30]
#define __pyx_n_u_test __pyx_string_tab[31]
#define __pyx_n_u_theta __pyx_string_tab[32]
#define __pyx_n_u_theta0 __pyx_string_tab[33]
#define __pyx_n_u_values __pyx_string_tab[34]
#define __pyx_n_u_zeros __pyx_string_tab[35]
#define __pyx_kp_b_iso88591_uF_1_b_a_A_b_q_3a_aq_q_as_1 __pyx_string_tab[36]
...
/* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":21
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9neuromass_6models_8kuramoto_7_native_11cpp_backend_1simulate_naive_kuramoto(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_9neuromass_6models_8kuramoto_7_native_11cpp_backend_simulate_naive_kuramoto, "Explicit Euler solver backed by a C++ kernel.");
static PyMethodDef __pyx_mdef_9neuromass_6models_8kuramoto_7_native_11cpp_backend_1simulate_naive_kuramoto = {"simulate_naive_kuramoto", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9neuromass_6models_8kuramoto_7_native_11cpp_backend_1simulate_naive_kuramoto, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9neuromass_6models_8kuramoto_7_native_11cpp_backend_simulate_naive_kuramoto};
static PyObject *__pyx_pw_9neuromass_6models_8kuramoto_7_native_11cpp_backend_1simulate_naive_kuramoto(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "simulate_naive_kuramoto", 0) < (0)) __PYX_ERR(0, 21, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 6; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("simulate_naive_kuramoto", 1, 6, 6, i); __PYX_ERR(0, 21, __pyx_L3_error) }
      }
    ...
    __pyx_v_epsilon = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_epsilon == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_dt = __Pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_dt == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_n_steps = __Pyx_PyLong_As_int(values[5]); if (unlikely((__pyx_v_n_steps == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("simulate_naive_kuramoto", 1, 6, 6, __pyx_nargs); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("neuromass.models.kuramoto._native.cpp_backend.simulate_naive_kuramoto", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_adjacency), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "adjacency", 0))) __PYX_ERR(0, 22, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_omega), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "omega", 0))) __PYX_ERR(0, 23, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_theta0), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "theta0", 0))) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_r = __pyx_pf_9neuromass_6models_8kuramoto_7_native_11cpp_backend_simulate_naive_kuramoto(__pyx_self, __pyx_v_adjacency, __pyx_v_omega, __pyx_v_theta0, __pyx_v_epsilon, __pyx_v_dt, __pyx_v_n_steps);
...
static PyObject *__pyx_pf_9neuromass_6models_8kuramoto_7_native_11cpp_backend_simulate_naive_kuramoto(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_adjacency, PyArrayObject *__pyx_v_omega, PyArrayObject *__pyx_v_theta0, double __pyx_v_epsilon, double __pyx_v_dt, int __pyx_v_n_steps) {
  int __pyx_v_n_nodes;
  ...
  __pyx_pybuffernd_theta0.rcbuffer = &__pyx_pybuffer_theta0;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_adjacency.rcbuffer->pybuffer, (PyObject*)__pyx_v_adjacency, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_omega.rcbuffer->pybuffer, (PyObject*)__pyx_v_omega, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_theta0.rcbuffer->pybuffer, (PyObject*)__pyx_v_theta0, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  ...
  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":31
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":32
 * 
 *     cdef int n_nodes = omega.shape[0]
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(             # <<<<<<<<<<<<<<
 *         (n_nodes, n_steps + 1),
...
*/
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":33
 *     cdef int n_nodes = omega.shape[0]
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(
 *         (n_nodes, n_steps + 1),             # <<<<<<<<<<<<<<
 *         dtype=np.float64,
 *     )
*/
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_v_n_nodes); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyLong_From_long((__pyx_v_n_steps + 1)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 33, __pyx_L1_error)
  ...
  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":34
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(
 *         (n_nodes, n_steps + 1),
 *         dtype=np.float64,             # <<<<<<<<<<<<<<
 *     )
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_float64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_dtype, __pyx_t_3, __pyx_t_5, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 32, __pyx_L1_error)
...
*/
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_theta.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_1), &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":38
 * 
...
*/
  ...
  __pyx_t_10 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_pybuffernd_adjacency.diminfo[0].shape;
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_10 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_adjacency.diminfo[0].shape)) __pyx_t_10 = 0;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_pybuffernd_adjacency.diminfo[1].shape;
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 1;
  } else if (unlikely(__pyx_t_9 >= __pyx_pybuffernd_adjacency.diminfo[1].shape)) __pyx_t_10 = 1;
  if (unlikely(__pyx_t_10 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_10);
    __PYX_ERR(0, 38, __pyx_L1_error)
  }

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":39
 *     simulate_naive_kuramoto_cpp(
 *         &adjacency[0, 0],
 *         &omega[0],             # <<<<<<<<<<<<<<
 *         &theta0[0],
...
*/
  ...
  __pyx_t_10 = -1;
  if (__pyx_t_11 < 0) {
    __pyx_t_11 += __pyx_pybuffernd_omega.diminfo[0].shape;
    if (unlikely(__pyx_t_11 < 0)) __pyx_t_10 = 0;
  } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_omega.diminfo[0].shape)) __pyx_t_10 = 0;
  if (unlikely(__pyx_t_10 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_10);
    __PYX_ERR(0, 39, __pyx_L1_error)
  }

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":40
 *         &adjacency[0, 0],
 *         &omega[0],
 *         &theta0[0],             # <<<<<<<<<<<<<<
 *         epsilon,
...
*/
  ...
  __pyx_t_10 = -1;
  if (__pyx_t_12 < 0) {
    __pyx_t_12 += __pyx_pybuffernd_theta0.diminfo[0].shape;
    if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 0;
  } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_theta0.diminfo[0].shape)) __pyx_t_10 = 0;
  if (unlikely(__pyx_t_10 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_10);
    __PYX_ERR(0, 40, __pyx_L1_error)
  }

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":45
 *         n_nodes,
 *         n_steps,
 *         &theta[0, 0],             # <<<<<<<<<<<<<<
 *     )
...
*/
  ...
  __pyx_t_10 = -1;
  if (__pyx_t_13 < 0) {
    __pyx_t_13 += __pyx_pybuffernd_theta.diminfo[0].shape;
    if (unlikely(__pyx_t_13 < 0)) __pyx_t_10 = 0;
  } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_theta.diminfo[0].shape)) __pyx_t_10 = 0;
  if (__pyx_t_14 < 0) {
    __pyx_t_14 += __pyx_pybuffernd_theta.diminfo[1].shape;
    if (unlikely(__pyx_t_14 < 0)) __pyx_t_10 = 1;
  } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_theta.diminfo[1].shape)) __pyx_t_10 = 1;
  if (unlikely(__pyx_t_10 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_10);
    __PYX_ERR(0, 45, __pyx_L1_error)
  }

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":37
 *     )
 * 
 *     simulate_naive_kuramoto_cpp(             # <<<<<<<<<<<<<<
 *         &adjacency[0, 0],
 *         &omega[0],
*/
  simulate_naive_kuramoto_cpp((&(*__Pyx_BufPtrCContig2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_adjacency.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_adjacency.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_adjacency.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_omega.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_omega.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_theta0.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_theta0.diminfo[0].strides))), __pyx_v_epsilon, __pyx_v_dt, __pyx_v_n_nodes, __pyx_v_n_steps, (&(*__Pyx_BufPtrCContig2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_theta.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_theta.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_theta.diminfo[1].strides))));

  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx":48
 *     )
 * 
 *     return theta             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_pymod_exec_cpp_backend(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cpp_backend},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "cpp_backend",
      __pyx_k_Cython_wrapper_around_the_C_impl, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_cpp_backend(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cpp_backend(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cpp_backend(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cpp_backend' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cpp_backend" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cpp_backend", 0);
  ...
  if (__pyx_module_is_main_neuromass__models__kuramoto___native__cpp_backend) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "neuromass.models.kuramoto._native.cpp_backend")) {
      if (unlikely((PyDict_SetItemString(modules, "neuromass.models.kuramoto._native.cpp_backend", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "src/neuromass/models/kuramoto/_native/cpp_backend_wrapper.pyx