...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "src/neuromass/models/kuramoto/_native/kuramoto_c_kernel.h"
        ],
        "include_dirs": [
        ...
        "sources": [
            "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx",
            "src/neuromass/models/kuramoto/_native/kuramoto_c_kernel.c"
        ]
    },
    "module_name": "neuromass.models.kuramoto._native.c_backend"
}
END: Cython Metadata */
...
#define __PYX_HAVE__neuromass__models__kuramoto___native__c_backend
#define __PYX_HAVE_API__neuromass__models__kuramoto___native__c_backend
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "neuromass.models.kuramoto._native.c_backend" */
...
#define __Pyx_MODULE_NAME "neuromass.models.kuramoto._native.c_backend"
extern int __pyx_module_is_main_neuromass__models__kuramoto___native__c_backend;
int __pyx_module_is_main_neuromass__models__kuramoto___native__c_backend = 0;

/* Implementation of "neuromass.models.kuramoto._native.c_backend" */
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9neuromass_6models_8kuramoto_7_native_9c_backend_simulate_naive_kuramoto(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_adjacency, PyArrayObject *__pyx_v_omega, PyArrayObject *__pyx_v_theta0, double __pyx_v_epsilon, double __pyx_v_dt, int __pyx_v_n_steps); /* proto */
...
/* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":21
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9neuromass_6models_8kuramoto_7_native_9c_backend_1simulate_naive_kuramoto(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_9neuromass_6models_8kuramoto_7_native_9c_backend_simulate_naive_kuramoto, "Explicit Euler solver backed by a C kernel.");
static PyMethodDef __pyx_mdef_9neuromass_6models_8kuramoto_7_native_9c_backend_1simulate_naive_kuramoto = {"simulate_naive_kuramoto", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9neuromass_6models_8kuramoto_7_native_9c_backend_1simulate_naive_kuramoto, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9neuromass_6models_8kuramoto_7_native_9c_backend_simulate_naive_kuramoto};
static PyObject *__pyx_pw_9neuromass_6models_8kuramoto_7_native_9c_backend_1simulate_naive_kuramoto(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("neuromass.models.kuramoto._native.c_backend.simulate_naive_kuramoto", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_9neuromass_6models_8kuramoto_7_native_9c_backend_simulate_naive_kuramoto(__pyx_self, __pyx_v_adjacency, __pyx_v_omega, __pyx_v_theta0, __pyx_v_epsilon, __pyx_v_dt, __pyx_v_n_steps);
...
static PyObject *__pyx_pf_9neuromass_6models_8kuramoto_7_native_9c_backend_simulate_naive_kuramoto(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_adjacency, PyArrayObject *__pyx_v_omega, PyArrayObject *__pyx_v_theta0, double __pyx_v_epsilon, double __pyx_v_dt, int __pyx_v_n_steps) {
  int __pyx_v_n_nodes;
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":31
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":32
 * 
 *     cdef int n_nodes = omega.shape[0]
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(             # <<<<<<<<<<<<<<
 *         (n_nodes, n_steps + 1),
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":33
 *     cdef int n_nodes = omega.shape[0]
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(
 *         (n_nodes, n_steps + 1),             # <<<<<<<<<<<<<<
 *         dtype=np.float64,
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":34
 *     cdef cnp.ndarray[cnp.float64_t, ndim=2, mode="c"] theta = np.zeros(
 *         (n_nodes, n_steps + 1),
 *         dtype=np.float64,             # <<<<<<<<<<<<<<
 *     )
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":38
 * 
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":39
 *     simulate_naive_kuramoto_c(
 *         &adjacency[0, 0],
 *         &omega[0],             # <<<<<<<<<<<<<<
 *         &theta0[0],
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":40
 *         &adjacency[0, 0],
 *         &omega[0],
 *         &theta0[0],             # <<<<<<<<<<<<<<
 *         epsilon,
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":45
 *         n_nodes,
 *         n_steps,
 *         &theta[0, 0],             # <<<<<<<<<<<<<<
 *     )
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":37
 *     )
 * 
 *     simulate_naive_kuramoto_c(             # <<<<<<<<<<<<<<
 *         &adjacency[0, 0],
...
static int __pyx_pymod_exec_c_backend(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_c_backend},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_c_backend(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_c_backend(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_c_backend(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'c_backend' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "c_backend" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_c_backend", 0);
  ...
  if (__pyx_module_is_main_neuromass__models__kuramoto___native__c_backend) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "neuromass.models.kuramoto._native.c_backend")) {
      if (unlikely((PyDict_SetItemString(modules, "neuromass.models.kuramoto._native.c_backend", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":3
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":6
 * cimport numpy as cnp
 * 
 * cnp.import_array()             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "src/neuromass/models/kuramoto/_native/c_backend_wrapper.pyx":1
 * """Cython wrapper around the C implementation of the naive Kuramoto solver."""             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init neuromass.models.kuramoto._native.c_backend", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init neuromass.models.kuramoto._native.c_backend");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{39},{34},{59},{20},{9},{18},{18},{2},{5},{7},{7},{8},{13},{5},{8},{10},{7},{7},{8},{43},{2},{5},{5},{3},{12},{12},{10},{23},{8},{5},{6},{6},{5},{106}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (573 bytes) */
const char* const cstring = "BZh91AY&SY\363T\2120\000\0007\177\376\347e\027ap\303\355A\257!p\000\277\377\377\360@@@@@\000\000@@\000\000@@\000@\001\305&\206\r  e'\250\364\324\364\004\311\243j\032\032\003F\203F\324z4z\247\224\032\236\240\310$\315&\005M2d\000\000\014@\003\010\365\036\241\022\236\312\237\251\244h\r44\320\001\240\000\000hd\000\003\232dd2`\206\214&\010\323F\214@\323&F\000\002&\023f\025\r\265\254\254\026 \020`\001\206j\234I1\264S\257\036\271\375\251\311\277S\341\355\253F\244\255#kZ\203\254\227\024\325\232\272:Q\363\013E\246\003 \036\321\220d\n5\314\330tw\350\267r\177;rm\301\256=\356o\223\234\0376\203\375k\t\034\031\345k\363y?\263\254\224r\004T$\202`\377TC\310ps\003\003\253\006\312I\374e\271\374\2249\005\001e\232y\323T\321\r\343\024\027P\362\244\014\021\247\240O\236\365\321(\216G\254\202+\3673\004\030\257\014,%D\032\036\006,'\177\212\324\244d%\312\206\215\341\330j\016\232\221''\032q\250\271xw_G\305\314\230\331K\203\204\314\362\337P\352M8 (\014\006\3547Y\2300\354\026\315\200c\273\rE\226\3145_8\270W\026\337\024\261\354\214\004\321A\305\204\030\007\000\305UH\200a\214$\211\262\004HJ\353\352$(\r\nI\222\304@\252\265\356\251\002=\305\211\013R\022\3119\037\211\254o\332X\024\215\235\221\023f\"\335b\262\310\002\022Z\231\262O\025\243\224\204\252\203hk1\277\220<_\2137\272\334\356\030