"""Benchmark Mean-Field : 8 threads."""
...
def build_problem(n_nodes):
    ...
    model = MeanFieldKuramotoModel(n_nodes=n_nodes, omega=omega, epsilon=3.8)
    return model, theta0
...
def save_csv(results, filename="execution_times_meanfield_8threads.csv"):
...
def main():
    ...
    print("=" * 70)
    print(f"  BENCHMARK MEAN-FIELD — {N_THREADS} THREADS")
    print("=" * 70)
